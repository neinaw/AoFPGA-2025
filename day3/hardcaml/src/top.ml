      ...
      [ sm.switch
        ...
        ; ( Accumulate
          , [ if_
                ...
                [ acc <-- uresize stack_o.gods_view ~width:num_bits +: uresize (acc.value *: of_unsigned_int 10 ~width: 4) ~width:num_bits
...
;;
  ...
  Scoped.hierarchical ~scope:scope ~name:"top" create
